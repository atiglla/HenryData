...
UPDATE carrera
SET nombre = 'Full Stack Developer'
WHERE idCarrera = 1;

UPDATE carrera
SET nombre = 'Data Science'
WHERE idCarrera = 2;
...
VALUES (2,'313262855','Beverly','Gardner','2006-10-03','2019-12-04',1235),
  ...
  (15,'171722128','Callum','Velazquez','2005-11-18','2019-12-17',1235),
  (16,'14374907','Kelly','Strickland','2005-11-26','2019-12-07',1235),
  (17,'49205318','Drake','Pearson','2009-08-08','2019-12-30',1235),
  (18,'398182472','Aimee','Cline','2009-11-19','2020-01-26',1235),
  (19,'401797157','Julian','Copeland','2001-01-09','2019-12-05',1235),
  (20,'4257391','Cecilia','Roth','2004-12-01','2019-12-17',1235);
  
INSERT INTO alumno (cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES ('19507661','Hillary','Holman','2001-04-07','2019-12-14',1235),
...
INSERT INTO alumno (cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES ('193744389','Belle','Cervantes','2001-02-03','2020-03-17',1235),
  ('43397060','Allegra','Dillon','2008-12-31','2020-02-12',1235),
  ('441149581','Reed','Goodwin','2002-02-21','2020-03-28',1235),
  ('88968476','Orla','Rocha','2007-07-25','2020-03-04',1235),
  ('211443618','Montana','Hunter','2003-08-26','2020-03-27',1235),
  ('86882779','Erich','Mcfarland','2000-07-04','2020-03-11',1235),
  ('407059433','Montana','Sykes','2006-12-15','2020-03-07',1235),
  ('223237649','Joshua','Mccoy','2006-11-19','2020-03-21',1235),
  ('292284624','Nicholas','Gibbs','2007-11-28','2020-02-04',1235),
  ('295743360','Felix','Avery','2005-03-16','2020-02-23',1235),
  ('444744855','Isabella','Edwards','2007-05-30','2020-03-17',1235),
  ('64776894','Zephr','Wright','1988-09-15','2020-03-22',1235),
  ('372278471','Caldwell','Mckenzie','1984-04-26','2020-03-18',1235),
  ('3026648K','Fiona','Gamble','1981-08-17','2020-03-05',1235),
  ('381918319','Margaret','Bentley','1981-07-25','2020-02-17',1235),
  ('29537372','Xena','Merrill','1985-12-05','2020-02-27',1235),
  ('343468598','Simone','Osborn','1988-08-27','2020-03-22',1235),
  ('465367539','Sonya','Conley','2009-03-06','2020-03-04',1235),
  ('171373085','Gannon','Villarreal','2001-12-25','2020-03-02',1235),
  ('3122182K','Elvis','Macdonald','2008-12-19','2020-04-12',1235);
...
INSERT INTO cohorte
VALUES (1237, 'FT-1237',  1, 1, '2022-05-01', '2022-06-01');
...
INSERT INTO cohorte
VALUES (1238, 'FT-1238',  1, 1, '2022-05-01', '2022-06-01');
...
INSERT INTO cohorte
VALUES (1239, 'FT-1239',  1, 1, '2022-02-01', '2022-06-01');
...
INSERT INTO cohorte
VALUES (1240, 'FT-1240',  1, 1, '2022-05-01', '2022-06-01'),
	    (1241, 'FT-1241',  1, 1, '2022-05-01', '2022-06-01'),
        (1242, 'FT-1242',  1, 1, '2022-05-01', '2022-06-01'),
        (1243, 'FT-1243',  1, 1, '2022-05-01', '2022-06-01'),
        (1244, 'FT-1244',  1, 1, '2022-05-01', '2022-06-01'),
        (1245, 'FT-1245',  1, 1, '2022-05-01', '2022-06-01'),
        (1246, 'FT-1246',  1, 1, '2022-05-01', '2022-06-01');
